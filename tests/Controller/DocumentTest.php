...
class DocumentTest extends ControllerBaseCase {
    ...
    public function testAnonSearch() : void {
        ...
        $repo->method('searchQuery')->willReturn([$this->getReference('document.1')]);
        $this->client->disableReboot();
        $this->client->getContainer()->set('test.' . DocumentRepository::class, $repo);
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertTrue($this->client->getResponse()->isRedirect('/document/1'));
        $responseCrawler = $this->client->followRedirect();
        $this->assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Title")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Path")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Summary")')->count());
    ...
    public function testAdminNew() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Path")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Summary")')->count());
